...
package com.divyanshu.splitter.utils
...
fun SplitterPeerType.stringify() = when (this) {
  SplitterPeerType.PUBLISHER -> "publisher"
  SplitterPeerType.SUBSCRIBER -> "subscriber"
}
